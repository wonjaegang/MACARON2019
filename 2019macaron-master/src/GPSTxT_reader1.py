...
class GPSTxT_leader():
        def __init__(self):
                ...
                ## Eightlines position 
                self.offset_X=_K_city_x
                self.offset_Y=_K_city_y
                ## K-city position
        ...
        #    a=np.loadtxt("catkin_ws/src/macaron/scripts/eightlight/8line_parking.txt",delimiter=',',dtype='double')
        ...
        #    a=np.loadtxt("catkin_ws/src/macaron/scripts/eightlight/manhae_left.txt",delimiter=',',dtype='double')
        #    a=np.loadtxt("catkin_ws/src/macaron/scripts/eightlight/manhae_right.txt",delimiter=',',dtype='double')
        #    a=np.loadtxt("catkin_ws/src/macaron/scripts/eightlight/track0906.txt",delimiter=',',dtype='double')
        #    a=np.loadtxt("catkin_ws/src/macaron/scripts/eightlight/final.txt",delimiter=',',dtype='double')
        #    a=np.loadtxt("catkin_ws/src/macaron/scripts/eightlight/macaron.txt",delimiter=',',dtype='double')
        
            line_name = "catkin_ws/src/macaron/scripts/eightlight/macaron"+".npy"     
        #    np.save(line_name,a)
            b=np.load(line_name)
            self.track_initiate()
        #     print(b)
        ...
        def track_initiate(self):
                ...
                for i in range(b.shape[0]):
                        if not(count%5):
                                ...
                                color=ColorRGBA(0.2, 0.6, 0.6, 0.8)
                                )
                                po.x=bm[count][0]
                                po.y=bm[count][1]
                                po.z=0
