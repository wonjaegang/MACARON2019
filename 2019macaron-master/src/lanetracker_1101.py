...
# ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ2차 로스 추가용 코드ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
            ...
            if add_debug_image3:
                ...
                putText(composed_image, Hz_text, (10, 490), fontFace, fontScale, (100, 200, 255), thickness, lineType=cv2.LINE_AA)
...
road_width = 4.7  # 차선 폭 (현재 3.5미터 실측 후 조정)
